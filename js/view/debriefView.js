var DebriefView = function (model, container){
  ...
  var p1 = $("<p>Je hebt alle vragen beantwoord. Hoewel we aangaven dat je nu terug naar het spel zou gaan, kun je vanaf nu beslissen om je deelname te beëindigen. Je doet dit door op de knop ‘Experiment Beëindigen’ te klikken. Echter, als je het spel nog wilt spelen, kun je op ‘Doorspelen’ klikken. Op elk moment tijdens het spelen kun je klikken op de knop ‘Experiment Beëindigen’ om je deelname alsnog te voltooien. </p>")
