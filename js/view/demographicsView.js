var DemographicsView = function( model, container ){
	...
	***********************************************************/
	...
	var form				= $( "<form role='form'>" );
  	...
  	var geslachttext     = $('<div style="font-size: 12px; font-weight:bold;  width: 100%"><p class="marginbottom">Geef alsjeblieft je geslacht aan.*</p> ');
	...
	var leeftijdtext     = $('<div style="font-size: 12px; font-weight:bold;  width: 100%"><p class="marginbottom">Wat is je huidige leeftijd?.</p> ');

	var experiencetext = $('<div style="font-size: 12px; font-weight:bold;  width: 100%"><p class="marginbottom">Heb je al eens eerder Mastermind gespeeld (fysiek dan wel digitaal)?*</p> ');
	var experienceinput 	= $ ("<div style='font-weight:bold; font-size: 12px; margin-bottom: 15px; width: 100%'><select name='experience' id='experienceMastermind' style='width:250px'><option value='0'>---------------</option><option value='1'>Ja</option><option value='2'>Nee</option><option value='3'>Weet ik niet meer</option>");
  	...
  	var selfratetext = $('<div style="font-size: 12px; font-weight:bold;  width: 100%"><p class="marginbottom">Hoe zou je jezelf beoordelen als Mastermind speler?*</p> ');
	...
	var gamefreqtext = $('<div style="font-size: 12px; font-weight:bold;  width: 100%"><p class="marginbottom">How vaak speel je normaal gesproken digitale games? Dit slaat ook op online en video games.*</p> ');
	...
	var remarkstext = $('<div style="font-size: 12px; font-weight:bold;  width: 100%"><p class="marginbottom">Heeft je opmerkingen over het spelen MasterMind en/of het beantwoorden van vragen tijdens dit experiment? (optioneel)</p> ');

	var emailtext = $ ('<div style="font-size: 12px; font-weight:bold; width: 100%"><p class="marginbottom"}>Laat hier alsjeblieft je e-mailadres achter als u mee wilt doen aan de loting voor een van de cadeaubonnen: (optioneel)</p> ');
