var DemographicsView = function( model, container ){
	...
	***********************************************************/
	...
	var experiencetext = $('<div style="font-size: 12px; font-weight:bold;  width: 100%"><p class="marginbottom">Heb je al eens eerder Mastermind gespeeld (zowel fysiek of digitaal)?*</p> ');
	...
	var gamefreqtext = $('<div style="font-size: 12px; font-weight:bold;  width: 100%"><p class="marginbottom">Hoe vaak speel je normaal gesproken digitale games? Dit slaat ook op online en video games.*</p> ');
	...
	var remarkstext = $('<div style="font-size: 12px; font-weight:bold;  width: 100%"><p class="marginbottom">Heb je opmerkingen over het spelen MasterMind en/of het beantwoorden van vragen tijdens dit experiment? (optioneel)</p> ');
