var DemographicsView = function( model, container ){
  ...
  var geslachttext     = $('<div style="font-size: 12px; font-weight:bold;  width: 100%"><p class="marginbottom">Geef alstublieft uw geslacht aan.</p> ');
	...
	var experienceinput 	= $ ("<div style='font-weight:bold; font-size: 12px; margin-bottom: 15px; width: 100%'><select name='experience' id='experience' style='width:250px'><option value='0'>---------------</option><option value='1'>Ja</option><option value='2'>Nee</option><option value='3'>Weet ik niet meer</option>");
